...
d3.sankey = function() {
    ...
    function computeNodePadding(n){
        let nodecount = 0
        n.forEach(function(d,i){
            nodecount = Math.max(nodecount,d.length)
        })
        nodePadding = Math.min(skheight / nodecount,8)
    ...
    function computeNodeDepths(iterations) {
        ...
        //computeNodePadding(nodesByBreadth)
        ...
        function initializeNodeDepth() {
            ...
            var ky = d3.min(nodesByBreadth, function(nodes,i) {
